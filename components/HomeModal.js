    ...
    >
      <div className={`scrollable-content ${styles.content}`}>
        <p className={styles.content}>
          ...
          detrás y qué buscan realmente? ¿Por qué cambiar reformas tan
          importantes para nuestro país en medio de una crisis que ha sacada a
          miles de peruanos a las calles en medio de una pandemia?
        </p>
        <FieldCongress
